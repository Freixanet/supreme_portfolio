...
export default function Contact() {
  ...
  return (
    <ParallaxSection id="contact" className="py-24 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* AI Suggestions */}
              <div className="card-surface elevation-1 p-4 border-l-4 border-sky-blue">
            ...
            {/* Reciprocity Element */}
            <div className="card-surface elevation-1 border border-minimal-secondary p-6">
              <h3 className="heading-card mb-3 text-minimal-secondary">
                FREE.CAREER.GUIDE
              </h3>
          ...
          <div className="space-y-8">
            {/* Direct Contact */}
            <div className="card-surface elevation-1 p-6">
              <h3 className="heading-card mb-6 text-sky-blue">
                DIRECT.CHANNELS
              </h3>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <Mail className="w-5 h-5 text-sky-blue" />
                  <span className="font-mono text-minimal-white">
                    hello@freixanet.dev
                  </span>
                </div>
                <div className="flex items-center space-x-3">
            ...
            {/* Response Time */}
            <div className="card-surface elevation-1 p-6 border-l-4 border-minimal-secondary">
              <h4 className="heading-card mb-2 text-minimal-secondary">
                RESPONSE.PROTOCOL
              </h4>
            ...
            {/* Availability Status */}
            <div className="card-surface elevation-1 border border-sky-blue p-6">
              ...
              <p className="text-sm text-minimal-white opacity-90 mb-4">
                Open to high-impact collaborations. Current capacity: 2 slots
                remaining for Q1 2025.
              </p>
